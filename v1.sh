...
echo -e ""
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "${BLUE}[+]                                                 [+]${NC}"
  echo -e "${BLUE}[+]                AUTO INSTALLER TUNNELING           [+]${NC}"
  echo -e "${BLUE}[+]                  © PIANSTORE              [+]${NC}"
  echo -e "${BLUE}[+]                                                 [+]${NC}"
  echo -e "${RED}[+] =============================================== [+]${NC}"
  echo -e ""
  echo -e "script ini di buat ole pian store dan memerlukan ijin buat install,"
...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/arilz11/IZINIP/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/arilz11/IZINIP/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/arilz11/IZINIP/main/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/arilz11/IZINIP/main/ip | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/arilz11/IZINIP/main/ip | grep $ipsaya | awk '{print $3}')
...
wget https://raw.githubusercontent.com/pianstore/vip/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
cd
...
echo -e "\033[92m      SELAMAT MENGUNAKAN       \033[0m"
echo -e "\033[96m==========================\033[0m"
echo -e ""
sleep 2
clear
